...
These two tables show the **Precision**, **Recall* and **F1** values and the rankings for each model for the three most important metrics, from which several conclusions can be drawn.
